...
export const heartsHowToPlay: HowToPlayDoc = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: ['The two of clubs leads the first trick. Follow suit if you can; the highest card of the led suit takes the trick and its winner leads next.'],
      bullets: [
        { label: 'First trick', text: 'no penalty cards may be thrown on it (house-rule toggle)' },
        { label: 'Breaking hearts', text: 'hearts cannot lead until one has been discarded on an earlier trick — unless your hand is nothing but hearts' },
        { label: 'Void', text: 'out of the led suit? Throw anything — this is where the queen lands on someone' },
      ],
    },
    {
      heading: 'Scoring a hand',
      body: ['When all thirteen tricks are played, each heart you captured is 1 point and the queen of spades is 13.'],
      bullets: [
        { label: 'Jack of diamonds', text: 'optional house rule — captures −10 for whoever takes her' },
        { label: 'Shooting the moon', text: 'capture ALL thirteen hearts plus the queen and you score zero while everyone else takes +26 — or, with the other house rule, your own score drops 26' },
      ],
    },
    {
      heading: 'The match',
