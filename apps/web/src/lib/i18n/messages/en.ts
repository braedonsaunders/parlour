...
export const en = {
  ...
  'narration.card': 'a card',
  'narration.turn': '{seat}’s turn.',
  'narration.drew': '{seat} drew a card.',
  'narration.discarded': '{seat} discarded {card}.',
  'narration.played': '{seat} played {card}.',
  'narration.tookTrick': '{seat} took the trick.',
  'narration.knocked': '{seat} knocked.',
  'narration.calledBlitz': '{seat} called blitz.',
  'narration.showdown': '{seat} revealed their hand.',
  'narration.lostLife': '{seat} lost a life; {lives} left.',
  'narration.gin': '{seat} called gin.',
  'narration.bigGin': '{seat} called big gin.',
  'narration.undercut': '{seat} undercut.',
  'narration.seatScore': '{seat} now has {score} points.',
  'narration.teamScore': 'Team {team} now has {score} points.',
  'narration.passed': '{seat} passed.',
  'narration.captured': '{seat} captured cards.',
  'narration.folded': '{seat} folded.',
  'narration.checked': '{seat} checked.',
  'narration.called': '{seat} called.',
  'narration.bet': '{seat} bet.',
  'narration.raised': '{seat} raised.',
  'narration.allIn': '{seat} went all in.',
  'narration.postedBlind': '{seat} posted a blind.',
  'narration.postedAnte': '{seat} posted an ante.',

  // --- solitaire controls and narration -----------------------------------
  'solitaire.undoMoves_one': 'Undo · {count} move',
  'solitaire.undoMoves_other': 'Undo · {count} moves',
  'solitaire.narration.moved': '{card} moved from {from} to {to}.',
  'solitaire.narration.movedRun': '{count} cards moved from {from} to {to}.',
  'solitaire.narration.revealed': '{card} revealed in {zone}.',
  'solitaire.narration.stockDeal': '{count} cards dealt across the tableau.',
  'solitaire.narration.recycled': 'The waste returned to the stock.',
  'solitaire.narration.pairRemoved': '{first} and {second} removed.',
  'solitaire.narration.removed': '{card} removed.',
  'solitaire.card': '{rank} of {suit}',
  'solitaire.rank.ace': 'ace',
  'solitaire.rank.jack': 'jack',
  'solitaire.rank.queen': 'queen',
  'solitaire.rank.king': 'king',
  'solitaire.suit.spades': 'spades',
  'solitaire.suit.hearts': 'hearts',
  'solitaire.suit.diamonds': 'diamonds',
  'solitaire.suit.clubs': 'clubs',
  'solitaire.zone.stock': 'the stock',
  'solitaire.zone.waste': 'the waste',
  'solitaire.zone.hole': 'the hole',
  'solitaire.zone.tableau': 'tableau column {column}',
  'solitaire.zone.foundation': 'foundation {foundation}',
  'solitaire.zone.suitFoundation': 'the {suit} foundation',
  'solitaire.zone.cell': 'free cell {cell}',
  'solitaire.zone.pyramid': 'pyramid row {row}, card {card}',
  'solitaire.zone.table': 'the table',
