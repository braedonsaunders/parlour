...
export const pt: Messages = {
  ...
  'tableMenu.appColors': 'Cores do app',
  'tableMenu.appColorsRicher': 'Mais vivas',
  'tableMenu.appColorsOriginal': 'Originais',
  'tableMenu.appliesEverywhere': 'Aplicado em todo lugar',
