...
export const es: Messages = {
  ...
  'room.listPublicly': 'Publicar esta mesa',
  'room.listPubliclyDetail':
    'Quien mire las mesas abiertas verá el juego, tu nombre y este código, y podrá sentarse.',
  'room.listedDetail':
    'Publicada hasta que se llene la última silla o repartas. Desmarca para quitarla.',

  // --- open-table browser ---------------------------------------------------
  'browse.heading': 'Mesas abiertas',
  'browse.searching': 'Buscando mesas abiertas…',
  'browse.empty': 'Ahora mismo no hay mesas abiertas. Escribe un código, o abre una y publícala.',
  'browse.hostedBy': 'Anfitrión: {host}',
  'browse.openHands': 'Manos abiertas',
  'browse.seatsOpen_one': '{count} silla libre',
  'browse.seatsOpen_other': '{count} sillas libres',
  'browse.strangersNote': 'Las mesas abiertas las abren desconocidos, no parlour.',
  ...
  'narration.card': 'una carta',
  'narration.turn': 'Turno de {seat}.',
  'narration.drew': '{seat} robó una carta.',
  'narration.discarded': '{seat} descartó {card}.',
  'narration.played': '{seat} jugó {card}.',
  'narration.tookTrick': '{seat} se llevó la baza.',
  'narration.knocked': '{seat} cerró.',
  'narration.calledBlitz': '{seat} cantó blitz.',
  'narration.showdown': '{seat} mostró su mano.',
  'narration.lostLife': '{seat} perdió una vida; le quedan {lives}.',
  'narration.gin': '{seat} cantó gin.',
  'narration.bigGin': '{seat} cantó gran gin.',
  'narration.undercut': '{seat} hizo undercut.',
  'narration.seatScore': '{seat} tiene ahora {score} puntos.',
  'narration.teamScore': 'El equipo {team} tiene ahora {score} puntos.',
  'narration.passed': '{seat} pasó.',
  'narration.captured': '{seat} capturó cartas.',
  'narration.folded': '{seat} se retiró.',
  'narration.checked': '{seat} pasó sin apostar.',
  'narration.called': '{seat} igualó.',
  'narration.bet': '{seat} apostó.',
  'narration.raised': '{seat} subió.',
  'narration.allIn': '{seat} fue con todo.',
  'narration.postedBlind': '{seat} puso una ciega.',
  'narration.postedAnte': '{seat} puso un ante.',

  // --- solitaire controls and narration -----------------------------------
  'solitaire.undoMoves_one': 'Deshacer · {count} movimiento',
  'solitaire.undoMoves_other': 'Deshacer · {count} movimientos',
  'solitaire.narration.moved': '{card} pasó de {from} a {to}.',
  'solitaire.narration.movedRun': '{count} cartas pasaron de {from} a {to}.',
  'solitaire.narration.revealed': 'Se reveló {card} en {zone}.',
  'solitaire.narration.stockDeal': 'Se repartieron {count} cartas por el tablero.',
  'solitaire.narration.recycled': 'El descarte volvió al mazo.',
  'solitaire.narration.pairRemoved': 'Se retiraron {first} y {second}.',
  'solitaire.narration.removed': 'Se retiró {card}.',
  'solitaire.card': '{rank} de {suit}',
  'solitaire.rank.ace': 'as',
  'solitaire.rank.jack': 'jota',
  'solitaire.rank.queen': 'reina',
  'solitaire.rank.king': 'rey',
  'solitaire.suit.spades': 'picas',
  'solitaire.suit.hearts': 'corazones',
  'solitaire.suit.diamonds': 'diamantes',
  'solitaire.suit.clubs': 'tréboles',
  'solitaire.zone.stock': 'el mazo',
  'solitaire.zone.waste': 'el descarte',
  'solitaire.zone.hole': 'el hoyo',
  'solitaire.zone.tableau': 'la columna {column} del tablero',
  'solitaire.zone.foundation': 'la base {foundation}',
  'solitaire.zone.suitFoundation': 'la base de {suit}',
  'solitaire.zone.cell': 'la celda libre {cell}',
  'solitaire.zone.pyramid': 'la fila {row}, carta {card}, de la pirámide',
  'solitaire.zone.table': 'la mesa',
