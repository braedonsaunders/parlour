...
import { SCOPA_MODES, type ScopaModeDef } from '@/lib/scopa/modes';
    ...
    <main className="flex min-h-dvh flex-col">
      <header className="flex items-center justify-between px-6 pt-5">
        ...
        <h1 className="font-display text-xl font-extrabold tracking-tight text-hearth-50">
          Scopa <span className="text-dusk-100/80">· pick your table</span>
        </h1>
...
function ModeTile({
  ...
  return (
    ...
    >
      ...
      <GameArt cards={getGameMode('scopa', def.id).art} />
